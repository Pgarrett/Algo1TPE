...
\aux{infoProductos}{s: Sistema, d: Drone}{[(Producto, Carga, [(\ent, \ent)])]}{[\\(Plaguicida, bateria(d) div 10, [posicionActual(d)]), \\
(PlaguicidaBajoConsumo, bateria(d) div 20, [posicionActual(d)]), \\
(Herbicida, bateria(d) div 20, [posicionActual(d)]), \\
(HerbicidaLargoAlcance, bateria(d) div 20, posicionActual(d):parcelasAdyacentesConMaleza(s,posicionActual(d)))]}
