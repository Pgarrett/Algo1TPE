...
%%%%%%%%%chequeen este, me entraron dudas si es asi de boludo o hay que tener en cuenta mas cosas%
\asegura {enVuelo(d) \Rightarrow (\res == vueloRealizado(d)) \land \neg (enVuelo(d)) \Rightarrow (\res == [])}
\end{problema}
